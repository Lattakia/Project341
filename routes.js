...
module.exports = function (app, passport) {
    ...
    app.get('/chat', checkAuthentication, function (req, res) {
     ...
     app.get('/private-chat', checkAuthentication, function (req, res) {
        var MongoClient = require('mongodb').MongoClient,
            format = require('util').format;
    ...
    app.get('/surveys-s2', checkAuthentication, function (req, res) {
        ...
        MongoClient.connect(URL, function (err, db) {
            ...
            var collection = db.collection('surveysvalues')
            collection.insert({
                question1: req.query.radioo,
                comments: req.query.mylittletextbox
            }, function (err, result) {
                collection.find({
                    name: req.query.radioo
...
function isLoggedIn(req, res, next) {
    ...
    if (req.isAuthenticated()) {
        return next();
    } else { // otherwise redirect them to the home page
